...
public class Main
{
    public static void main(String[] args)
    {
        ...
        internistKate.addSchedule(monday, LocalTime.of(8,0),LocalTime.of(16,0),30);
        cardiologistJane.addSchedule(monday, LocalTime.of(9,0),LocalTime.of(17,0),30);
        ...
        //kateMon25.addVisit(LocalTime.of(8,0));
        //kateMon25.addVisit(LocalTime.of(8,30));
        kateMon25.followRecurringSchedule();

        DoctorSchedule janeMon25 = new DoctorSchedule(cardiologistJane, date, generalMon25);
        //janeMon25.addVisit(LocalTime.of(8,30));
        janeMon25.followRecurringSchedule();
